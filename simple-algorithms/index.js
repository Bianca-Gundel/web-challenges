...
function findLongestWord(words) {
  ...
  console.log(
    "The longest word is: " + longestWord + " with " + wordLength + " letters!"
  );
  return longestWord;
}
...
function averageWordLength(words) {
  ...
  words.forEach((word) => {
    averageLength = averageLength + word.length;
  });
...
function doesWordExist(haystack, needle) {
  // TODO:
  // if (
  //   wordsFind.includes(haystack) === true ||
  //   wordsFind.includes(needle) === true
  // ) {
  //   return [wordsFind[2], wordsFind[3]];
  // }
  // findIndex()
  // haystack.findIndex((needles) => needles.includes(needle));
  // console.log(needles);
}
// doesWordExist(wordsFind, "x");
// Count repetition
